...
public class Frame_mul extends javax.swing.JDialog {

    public Frame_mul(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Frame_mul dialog = new Frame_mul(new javax.swing.JFrame(), true);
