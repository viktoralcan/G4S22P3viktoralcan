...
public class Frame_resta extends javax.swing.JDialog {

    public Frame_resta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Frame_resta dialog = new Frame_resta(new javax.swing.JFrame(), true);
